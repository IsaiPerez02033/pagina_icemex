...
export const metadata: Metadata = {
  ...
  description:
    "ICEMEX S.A. de C.V. — Más de 20 años fabricando y distribuyendo luminarias LED, postes cónicos y rectos, herrajes, bases de concreto y material eléctrico. Iluminación pública, solar, comercial e industrial e instalación de cámaras de seguridad (CCTV) en toda la República Mexicana.",
  keywords: [
    "ICEMEX",
    "iluminación pública",
    "luminarias LED",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Fabricación, distribución y comercialización de material eléctrico, herrajes, postería y luminarias LED, e instalación de cámaras de seguridad (CCTV). Alumbrado público, iluminación solar, postes, reflectores, brazos y videovigilancia en México desde 2004.",
              url: "https://icemex.mx",
              ...
              hasOfferCatalog: {
                ...
                itemListElement: [
                  ...
                  { "@type": "Offer", itemOffered: { "@type": "Service", name: "Instalación de cámaras de seguridad (CCTV)" } },
                ],
              },
            }),
          }}
